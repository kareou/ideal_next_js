        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Ready to resolve your tax issues? Our experienced team is here to help. 
              Contact us today for your free consultation and take the first step toward financial freedom.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Multiple ways to reach our tax experts. Choose the method that works best for you.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactMethods.map((method, index) => (
              <div key={index} className="text-center p-6 border-2 border-gray-100 rounded-xl hover:border-brand-teal transition-all duration-300 hover:shadow-lg">
                <div className="mx-auto mb-4 p-3 bg-mint-50 rounded-full w-fit">
                  {method.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">{method.title}</h3>
                <p className="text-brand-blue font-semibold mb-2">{method.details}</p>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              The longer you wait, the more your tax problems can grow. Contact us now 
              for immediate assistance and start your journey to financial freedom.
            </p>
            <Button 
              size="lg" 
