  ...
  const blogPosts = [
    {
      ...
      title: "NFT Tax Guide",
      excerpt:
        "While NFTs and cryptocurrencies are hot topics in the news, understanding the tax implications of NFT transactions is far from clear. If",
    ...
    },
    {
      ...
      excerpt:
        "Taxpayers are required to report all gambling wins to the IRS as additional income, but the good news is that if",
      author: "Tax Experts",
      date: "August 28, 2023",
      category: "Tax Tips",
    ...
    },
    {
      ...
      excerpt:
        "Independent contractors, freelancers, gig workers, and other self-employed individuals use the IRS W9 Form, known as a Request for Taxpayer Identification Number",
      author: "Form Specialists",
      date: "August 28, 2023",
      category: "Tax Forms",
      slug: "/w9-form",
    },
    {
      ...
      excerpt:
        "In the U.S., employees are required to pay taxes to the IRS on their earned income. However, rather than being required",
    ...
    },
    {
      ...
      excerpt:
        "Employers must fill out a copy of the IRS W-2 Form, Wage and Tax Statement, for every",
      author: "Payroll Specialists",
      date: "August 17, 2023",
      category: "Payroll Tax",
      slug: "/w-2-form",
    },
    {
      ...
      excerpt:
        "A 1099 form, also referred to as an information return, is a tax form used to",
      author: "Form Specialists",
      date: "August 17, 2023",
      category: "Tax Forms",
      slug: "/irs-1099-form",
    },
    {
      ...
      excerpt:
        "IRS Form 9465, Installment Agreement Request, is a tax form that individuals can file to request",
    ...
    },
    {
      ...
      excerpt:
        "Americans who are working abroad can save money on taxes by claiming the foreign tax credit using IRS Form 1116, Foreign",
    ...
    },
    {
      ...
      excerpt:
        "IRS Form 2848, Power of Attorney and Declaration of Representative, is a tax form used to",
      author: "Legal Team",
      date: "August 17, 2023",
      category: "Tax Forms",
      slug: "/irs-form-2848",
    },
    {
      ...
      excerpt:
        "The Work Opportunity Tax Credit (WOTC) is a federal tax credit offered by the IRS to",
    ...
    },
    {
      ...
      excerpt:
        "It is unsurprising to most people that non-renewable energy sources can only support our residential, commercial, and industrial power needs for",
