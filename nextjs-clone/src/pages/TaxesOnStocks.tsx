        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-xl text-gray-600 mb-8">
              Taxes on stocks must be paid when an individual earns dividends as
              a shareholder or sells stocks for a profit, creating taxable
              events that require proper reporting on your tax return.
            </p>
            ...
            <p className="mb-4">
              When you sell stocks for more than you paid, you realize a capital
              gain. The tax rate depends on how long you held the stock:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>
                <strong>Short-term capital gains:</strong> Stocks held for one
                year or less, taxed as ordinary income
              </li>
              <li>
                <strong>Long-term capital gains:</strong> Stocks held for more
                than one year, taxed at preferential rates (0%, 15%, or 20%)
              </li>
            </ul>
            ...
            <p className="mb-6">
              Dividends received from stock ownership are generally taxable.
              Most dividends qualify for long-term capital gains tax rates, but
            ...
            <p className="mb-6">
              You can offset capital gains with capital losses from other
              investments. If your losses exceed your gains, you can deduct up
              to $3,000 of net losses against other income annually, with
            ...
            <p className="mb-6">
              Consider holding stocks in tax-advantaged accounts like 401(k)s
              and IRAs to defer or eliminate taxes on gains and dividends,
              allowing your investments to grow more efficiently.
            </p>
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              ...
              <p className="text-gray-600 mb-4">
                Our tax professionals can help you navigate the complexities of
