      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Purpose of WOTC</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Qualifying Target Groups</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Credit Amounts</h2>
            <p className="mb-6">
              The credit varies by target group and hours worked:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>Generally 25% of first-year wages up to $6,000 (maximum $1,500 credit)</li>
              <li>40% of first-year wages if employee works 400+ hours (maximum $2,400 credit)</li>
              <li>Special rates for veterans and certain other groups</li>
              <li>Summer youth: 25% of first-year wages up to $3,000 (maximum $750 credit)</li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              ...
              <li>Have employee complete IRS Form 8850 and ETA Form 9061/9062</li>
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>Pre-screen potential employees for target group membership</li>
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Benefits for Employers and Employees</h2>
            <p className="mb-6">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Need Help with WOTC?</h3>
              <p className="text-gray-600 mb-4">
                Maximizing the Work Opportunity Tax Credit requires proper documentation and timely filing. Our business tax specialists can help you navigate the process.
              </p>
              <Link
