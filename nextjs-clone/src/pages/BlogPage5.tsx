  ...
  const blogPosts = [
    {
      ...
      excerpt: "TABLE OF CONTENTS What Is The IRS 10 Year Rule?When Does The Statute Of Limitations 10-Year",
    ...
    },
    {
      ...
      excerpt: "Explained Facing a situation in which paying your tax debt would cause you unreasonable financial hardship where you cannot afford your basic",
    ...
    },
    {
      ...
      excerpt: "There are many tips taxpayers can utilize to optimize their outcome when it comes to taxes, but here are",
    ...
    },
    {
      ...
      excerpt: "One of the many benefits of reaching the age of 65 in the United States is that you begin",
    ...
    },
    {
      ...
      excerpt: "Taxpayers who are financially responsible for other people can receive tax breaks by claiming them as",
    ...
    },
    {
      ...
      excerpt: "TABLE OF CONTENTS What Is The Earned Income Tax Credit?Earned Income Tax Credit Eligibility RequirementsHow Much Is The 2023 Earned",
    ...
    },
    {
      ...
      excerpt: "Receiving a notification that your tax account will be audited by the IRS is already stressful",
    ...
    },
    {
      ...
      excerpt: "If you have applied for an EIN for your new business, be on the lookout for a CP 575 letter in",
    ...
    },
    {
      ...
      excerpt: "Small businesses operating in the United States have the benefit of modifying their business structure to optimize their tax savings, such",
    ...
    },
    {
      ...
      excerpt: "It's okay if your business information has changed since you initially applied for an Employer Identification Number (EIN) for your company",
    ...
    },
    {
      ...
      excerpt: "TABLE OF CONTENTS What Is A 147c Letter? CP 575 or 147c? How To Request EIN Verification Letter 147c Can My EIN",
    ...
    },
    {
      ...
      excerpt: "Taxpayers may determine their eligibility for a tax refund when filing their tax return by listing their income, calculating their",
          ...
          <div className="mt-12">
            <Pagination>
              <PaginationContent>
                ...
                <PaginationItem>
                  <PaginationLink href="/blog/5" isActive>5</PaginationLink>
                </PaginationItem>
