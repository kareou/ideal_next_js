        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Our experienced professionals are dedicated to providing exceptional tax resolution services 
              and ensuring complete client satisfaction.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 mb-16">
            ...
            <div className="bg-gradient-to-br from-mint-50 to-deep-blue-50 rounded-2xl p-8">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Faris Khatib</h3>
                <p className="text-brand-teal font-semibold text-lg">CEO</p>
              </div>
              <p className="text-gray-700 leading-relaxed">
                With over a decade of expertise in nurturing and managing tax resolution firms, Faris contributes a wealth of knowledge in the industry. Playing a pivotal role as a founding member of Ideal Tax, his primary objective is to deliver optimal client service coupled with the finest tax relief solutions available. Faris holds the belief that the essential factor in ensuring complete client satisfaction with the services rendered lies in the thorough ongoing training of our employees.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Our staff of independent Tax Attorneys and Enrolled Agents continue to expand their knowledge so to provide new and innovative ways in helping clients resolve their burdensome tax problems. IT also embraces the differences and uniqueness between our clients and their needs, and we work hard to develop an individualized relationship with each of our clients.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              We also offer professional tax preparation for clients who already have retained us for other services.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Numbers that demonstrate our commitment to helping taxpayers achieve financial freedom.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join thousands of satisfied clients who have achieved tax relief with our help. 
