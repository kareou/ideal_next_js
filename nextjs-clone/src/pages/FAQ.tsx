...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "In the case of anyone with delinquent taxes, a fresh start would be the dream. The IRS Fresh Start Program is available to taxpayers who owe back taxes and meet certain criteria, including individuals and small businesses with tax debt under specific thresholds and those experiencing financial hardship."
    },
    {
      question: "How Can I Reduce My Tax Bill?",
      answer: "Getting your tax bill is likely never your favorite time of the year. However, getting a bill that's not what you expected can add stress to your life and your wallet. There are several legitimate ways to reduce your tax bill, including maximizing deductions, tax credits, proper tax planning, and exploring available relief programs."
    },
    {
      question: "Do I Need to File a Tax Return?",
      answer: "When tax time comes around each year, it may be a question on some people's minds. 'Do I need to file taxes this year?' Although the short answer, if you think you need to file, is likely 'yes,' there are instances where you might not actually have to file based on your income level, filing status, and age."
    },
    {
      question: "What Happens If I File My Taxes Late?",
      answer: "It comes around every year like clockwork and, although we know when to expect that dreaded bill, many of us still file our taxes late. Filing taxes late can result in penalties and interest charges, and the longer you wait, the more expensive it becomes. It's important to file as soon as possible to minimize these costs."
    },
    {
      question: "What Is Tax Fraud?",
      answer: "When many of us think of tax fraud, we might instinctively think about those Blockbuster movies where the corporate CEO heads off to prison for lying about how much money he made or evading taxes by sending cash to the Cayman Islands. Tax fraud involves deliberately falsifying information on tax returns to reduce tax liability, and it can result in serious legal consequences."
    }
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Find answers to common questions about tax relief services and how IdealTax can help resolve your tax issues.
            </p>
          </div>
        </div>
      </section>
