  ...
  const faqs = [
    {
      ...
      answer:
        "If you find yourself looking for tax debt forgiveness, the best thing to do is to reach out to the tax professionals at Ideal Tax today. We can evaluate your specific situation and determine which debt relief programs you may qualify for based on your financial circumstances.",
    },
    {
