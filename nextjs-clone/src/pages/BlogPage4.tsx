  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "TABLE OF CONTENTS What Are Robinhood Taxes? What Robinhood Activity Is Taxable? Capital Gains and Losses How To File Robinhood Taxes Tax",
    ...
    },
    {
      ...
      excerpt:
        "Coinbase is an online platform where people can invest and trade hundreds of cryptocurrencies, but what they may not realize, is that,",
    ...
    },
    {
      ...
      excerpt:
        "Updated August 2023 A career in ministry is a fulfilling job for giving back to the community, but you may",
    ...
    },
    {
      ...
      excerpt:
        "Explained Updated June 2023 If you have been awarded settlement money as a result of winning a lawsuit, think",
    ...
    },
    {
      ...
      excerpt:
        "All taxpayers are obligated to comply with tax laws at the local, state, and federal levels, otherwise, they may be",
    ...
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS How To Avoid Tax Penalties With The IRS Fresh Start Program",
    ...
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS Does Owing The IRS Affect Your Credit Score?What Is A Credit Score?During What Situation",
    ...
    },
    {
      ...
      excerpt:
        "You've probably read these press release headlines before: \"Business Owner Pleads Guilty To Tax Evasion And Sentenced To Five Years In",
      author: "Legal Team",
      date: "June 13, 2023",
      category: "Tax Tips",
    },
    {
      ...
      excerpt:
        "There are cash advantages for people who become informants and report tax cheats to the IRS,",
    ...
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS IRS Audit Process TimelineWhat Is An IRS Tax Audit?Timelines For Different IRS AuditsCommon Factors That Can Extend",
    ...
    },
    {
      ...
      excerpt:
        "Tax audits involve the IRS investigating your tax account to verify the accuracy of tax",
      author: "Audit Experts",
      date: "May 22, 2023",
      category: "Tax Tips",
    },
    {
      ...
      excerpt:
        "If you have concerns about your ability to pay your tax bill, the idea of spending money on hiring a tax",
      author: "Legal Team",
      date: "May 15, 2023",
      category: "Tax Tips",
    },
          ...
          <div className="mt-12">
            <Pagination>
              <PaginationContent>
                ...
                <PaginationItem>
                  <PaginationLink href="/blog/4" isActive>
                    4
                  </PaginationLink>
                </PaginationItem>
                <PaginationItem>
