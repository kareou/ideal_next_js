      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Understanding Gambling Income</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">What is a Win/Loss Statement?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Deducting Gambling Losses</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Professional vs. Casual Gambling</h2>
            <p className="mb-6">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Need Help with Gambling Tax Issues?</h3>
