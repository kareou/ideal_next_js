      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">What Is Form 4852?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">When to Use Form 4852</h2>
            <p className="mb-6">
              You should use Form 4852 only as a last resort when:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>You haven't received your W-2 or 1099-R by January 31</li>
              <li>You've contacted your employer but they haven't provided the form</li>
              <li>The W-2 or 1099-R you received contains incorrect information</li>
              <li>You need to file your tax return but don't have the required forms</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-800 mb-4">Before Filing Form 4852</h2>
            <p className="mb-6">
              Before using Form 4852, you must:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li>Contact your employer to request the missing or corrected form</li>
              <li>Contact the IRS at 800-829-1040 if you haven't received your W-2 by February 15</li>
              <li>Gather all available documentation of your wages and withholdings</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-800 mb-4">Information Required</h2>
            <p className="mb-6">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Missing Tax Documents?</h3>
              <p className="text-gray-600 mb-4">
                Our tax professionals can help you handle missing tax documents and ensure your return is filed correctly and on time.
              </p>
              <Link
