      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">What Is Form 1040?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Key Sections of Form 1040</h2>
            
            <h3 className="text-xl font-semibold text-gray-700 mb-3">Filing Information</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-3">Income Section</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-3">Deductions</h3>
            <p className="mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-3">Tax Credits</h3>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Supporting Schedules</h2>
            <p className="mb-6">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Need Help Filing Form 1040?</h3>
