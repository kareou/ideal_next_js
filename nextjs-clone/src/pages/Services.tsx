  ...
  const services = [
    {
      title: "Tax Audits",
      description:
        "Professional representation and defense during IRS audits to protect your rights and interests.",
    ...
    },
    {
      ...
      description:
        "Stop wage garnishments and negotiate payment plans to get your finances back on track.",
    ...
    },
    {
      title: "Bank Levy",
      description:
        "Release bank levies and protect your accounts from IRS seizure actions.",
      icon: <Shield className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      ...
      description:
        "Reduce or eliminate IRS penalties through proper documentation and negotiation.",
    ...
    },
    {
      ...
      description:
        "Safeguard your assets from IRS collection actions and seizure attempts.",
      icon: <Shield className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      ...
      description:
        "Negotiate affordable monthly payment plans with the IRS for tax debt relief.",
    ...
    },
    {
      ...
      description:
        "Settle your tax debt for less than the full amount owed through OIC programs.",
    ...
    },
    {
      ...
      description:
        "Temporarily halt IRS collection activities when facing financial hardship.",
    ...
    },
    {
      ...
      description:
        "Protection for spouses who shouldn't be held liable for their partner's tax debt.",
      icon: <Shield className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      ...
      description:
        "Correct errors on previously filed returns and claim missed deductions.",
      icon: <FileText className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      title: "Back Taxes",
      description:
        "Comprehensive solutions to resolve back tax debt and get you back on track.",
      icon: <Calculator className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      title: "Seizure",
      description:
        "Stop IRS asset seizures and protect your property from collection actions.",
    ...
    },
    {
      ...
      description:
        "Reduce the impact of tax liens on your credit and financial opportunities.",
      icon: <FileText className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      ...
      description:
        "Defend against personal liability for business payroll tax penalties.",
      icon: <Shield className="w-8 h-8 text-brand-teal" />,
    ...
    },
    {
      ...
      description:
        "Comprehensive tax protection services to keep you compliant and protected.",
      icon: <CheckCircle className="w-8 h-8 text-brand-teal" />,
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Comprehensive Tax{" "}
              <span className="text-brand-teal">Relief Services</span>
            </h1>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              From IRS audits to wage garnishments, our experienced team
              provides professional tax resolution services to help you overcome
              any tax challenge.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We offer a comprehensive range of tax services designed to resolve
              your tax issues and provide you with the peace of mind you
              deserve.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="border-2 border-gray-100 hover:border-brand-teal transition-all duration-300 hover:shadow-lg group"
              >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700">
                ...
                taxpayers resolve their tax issues and achieve financial peace
                of mind.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Don't let tax problems control your life. Contact us today for a
              free consultation and discover how we can help you achieve tax
              relief.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
