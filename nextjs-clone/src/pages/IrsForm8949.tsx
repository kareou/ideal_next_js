      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">What Is Form 8949?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">When Do You Need Form 8949?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Parts of Form 8949</h2>
            
            <h3 className="text-xl font-semibold text-gray-700 mb-3">Part I - Short-Term Transactions</h3>
            <p className="mb-4">
              Report sales of capital assets held for one year or less. Short-term capital gains are taxed as ordinary income.
            </p>

            <h3 className="text-xl font-semibold text-gray-700 mb-3">Part II - Long-Term Transactions</h3>
            <p className="mb-6">
              Report sales of capital assets held for more than one year. Long-term capital gains receive preferential tax treatment.
            </p>

            <h2 className="text-2xl font-bold text-gray-800 mb-4">Required Information</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Connection to Schedule D</h2>
            <p className="mb-6">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Need Help with Form 8949?</h3>
