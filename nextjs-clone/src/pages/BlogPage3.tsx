  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "If you are planning your wealth management strategies for investing, you may have looked into the different areas where you",
    ...
    },
    {
      ...
      excerpt:
        "Adopting new children into the family brings an indescribable level of joy, pride, and happiness. However, despite the love and satisfaction that",
      author: "Tax Experts",
      date: "July 28, 2023",
      category: "Tax Credits",
    },
    {
      ...
      excerpt:
        "Employers have many factors to consider when it comes to taxes – not only do they have to maintain",
    ...
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS What Is FUTA?Who Has To Pay FUTA Taxes?Which Wages Are Not Subject To FUTA Tax?How To",
      author: "Payroll Specialists",
      date: "July 25, 2023",
      category: "Payroll Tax",
    },
    {
      ...
      excerpt:
        "One of the most exciting parts about turning 65 is the opportunity to receive Medicare healthcare insurance that covers visits to your",
    ...
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS What Are FICA Taxes? What Is Medicare? What Is Social Security? How To Pay FICA Taxes FICA Tax Rates",
      author: "Payroll Specialists",
      date: "July 24, 2023",
      category: "Payroll Tax",
    },
    {
      ...
      excerpt:
        "TABLE OF CONTENTS What Is IRS Form 720? What Are Excise Taxes? Who Is Required To File IRS Form 720? When",
    ...
    },
    {
      ...
      excerpt:
        "Gross pay is the hourly rate or salary that employees are paid before taxes and other withholdings are",
      author: "Payroll Specialists",
      date: "July 24, 2023",
      category: "Payroll Tax",
    },
    {
      ...
      excerpt:
        "If you're seeking help with your tax situation, you may have realized that there are many types of",
      author: "Legal Team",
      date: "July 21, 2023",
      category: "Tax Tips",
    },
    {
      ...
      excerpt:
        "Purchasing a vehicle is a large investment, so it is natural for taxpayers to be seeking any areas",
    ...
    },
    {
      ...
      excerpt:
        "These similar phrases can be used interchangeably in most cases, but there are slight differences that",
    ...
    },
    {
      ...
      excerpt:
        "Taxpayers are at risk of losing their homes if they don't pay their property taxes, so before",
      author: "Property Tax Team",
      date: "July 7, 2023",
      category: "Tax Tips",
    },
          ...
          <div className="mt-12">
            <Pagination>
              <PaginationContent>
                ...
                <PaginationItem>
                  <PaginationLink href="/blog/3" isActive>
                    3
                  </PaginationLink>
                </PaginationItem>
                <PaginationItem>
