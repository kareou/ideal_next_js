        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Professional tax preparation services that maximize your refund
              and ensure full compliance with IRS requirements. Let our experts
              handle your taxes.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Our certified tax professionals provide comprehensive tax
                preparation services for individuals and businesses. We ensure
                accuracy, maximize your refund, and keep you compliant with all
                tax laws.
              </p>
            ...
            <div className="bg-gradient-to-br from-mint-100 to-deep-blue-100 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-700">
                ...
                accurately and efficiently, ensuring you get every deduction you
                deserve.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Let our experts handle your tax preparation while you focus on
              what matters most. Get started with professional tax services
              today.
            </p>
            <Button
              size="lg"
