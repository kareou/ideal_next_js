                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2 w-full">
                    ...
                    <textarea
                      ...
                      className="mt-1 border-gray-300 focus:border-brand-teal focus:ring-brand-teal w-full min-h-[200px] rounded-md p-3 border resize-y"
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      You can use HTML tags for formatting (e.g., &lt;h1&gt;, &lt;p&gt;, &lt;strong&gt;, &lt;em&gt;, etc.)
                    </p>
                  </div>
                </div>
                <div className="flex gap-3 mt-6">
