        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              ...
              about their experience with IdealTax's professional tax resolution services.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Real stories from real people who have achieved tax relief with IdealTax.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-deep-blue-50 to-mint-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Our commitment to excellence recognized by the Better Business Bureau.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join thousands of satisfied clients who have achieved tax relief with IdealTax. 
