        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              ...
              using Ideal Tax Solution services, you agree to these terms.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  The Ideal Tax Solution, LLC application and the associated
                  Ideal Tax Solution, LLC website available at
                  www.idealtaxsolution.com ("Ideal Tax Solution, LLC") are owned
                  and operated by Ideal Tax Solution, LLC ("us" "we" or "our").
                  This Ideal Tax Solution, LLC Terms Of Use (the "Terms Of Use")
                  is intended to inform you of our policies and practices
                  regarding the collection, use and disclosure of any
                  information you submit to us through Ideal Tax Solution, LLC.
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  By accessing or otherwise using Ideal Tax Solution, LLC, you
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Tax Solution, LLC and we do not intentionally collect or
                  ...
                  using Ideal Tax Solution, LLC, you are representing that you
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Ideal Tax Solution, LLC in order to display you as a friend or
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  postings, comments, or forums within the Ideal Tax Solution,
                  LLC community.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  through Ideal Tax Solution, LLC, we will collect your e-mail
                  ...
                  email notification to a friend through Ideal Tax Solution, LLC
                  or the social network from which you have connected to Ideal
                  Tax Solution, LLC (such as in an invitation, or when sharing
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  As you use Ideal Tax Solution, LLC, certain information may
                  ...
                  displayed on Ideal Tax Solution, LLC you clicked. This type of
                  information is collected to make Ideal Tax Solution, LLC and
                  solutions more useful to you and to tailor the experience with
                  Ideal Tax Solution, LLC to meet your special interests and
                  needs.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  personal and interactive experience with Ideal Tax Solution,
                  LLC. Persistent Cookies can be removed by following your
                  Internet browser help file directions. In order to use our
                  services offered through Ideal Tax Solution, LLC, your web
                  browser must accept Cookies. If you choose to disable Cookies,
                  some aspects of Ideal Tax Solution, LLC may not work properly,
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  submit to us is used by us to provide you access to Ideal Tax
                  Solution, LLC, to improve Ideal Tax Solution, LLC, to better
                  tailor the features, performance, and support of Ideal Tax
                  Solution, LLC and to offer you additional information,
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  some of the services and features of Ideal Tax Solution, LLC
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Tax Solution, LLC, certain information you post or provide
                  through Ideal Tax Solution, LLC, such as your name, profile,
                  comments, posts and ratings, may be shared with other users
                  and posted on publicly available portions of Ideal Tax
                  Solution, LLC, including without limitation, chatrooms,
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Ideal Tax Solution, LLC may contain links to other websites.
                  ...
                  website they visit. This Ideal Tax Solution, LLC applies
                  solely to information collected by us through Ideal Tax
                  Solution, LLC and does not apply to these third-party
                  websites.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-4">
                    ...
                    <a
                      href="mailto:customercare@idealtaxsolution.com"
                  ...
                  <p className="text-gray-700">
                    ...
                    cease using Ideal Tax Solution, LLC. Continued use of Ideal
                    Tax Solution, LLC following notice of any such changes shall
