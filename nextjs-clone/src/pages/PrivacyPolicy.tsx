            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  may be asked to enter your name, email address, phone number,
                  Tax Debt or other details to help you with your experience.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  maintain the safety of your personal information. For your
                  convenience we may store your credit card information longer
                  than 30 days in order to expedite future orders, and to
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  have your computer warn you each time a cookie is being sent,
                  or you can choose to turn off all cookies. You do this through
                  your browser (like Internet Explorer) settings. Each browser
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  our website. Google's advertising requirements can be summed
                  up by Google's Advertising Principles. They are put in place
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  According to CalOPPA we agree to the following: Users can
                  visit our site anonymously once this privacy policy is
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  information: By Emailing Us, By Calling Us, By Chatting With
                  Us Or Sending Us A Ticket.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  How does our site handle do not track signals? We honor do not
                  track signals and do not track, plant cookies, or use
                  advertising when a Do Not Track (DNT) browser mechanism is in
                  place.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Does our site allow third party behavioral tracking? It's also
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  occur: We will notify the users via email within 7 Business
                  Days.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  MSG frequency varies. Msg and data rates may apply. Reply Help
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-2">
                    <strong>Email:</strong> privacy@idealtax.com
                  </p>
                  <p className="text-gray-700 mb-2">
                    <strong>Phone:</strong> (877) 518-2860
                  </p>
                  <p className="text-gray-700">
                    <strong>Address:</strong> 240 Progress Suite 250, Irvine, CA
                    92618
                  </p>
                </div>
              </div>
