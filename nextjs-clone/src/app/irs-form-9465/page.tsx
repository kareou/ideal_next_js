      ...
      <div className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">When to Use Form 9465</h2>
            <p className="mb-6">
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              ...
              <li>You owe $50,000 or less in combined tax, penalties, and interest</li>
            </ul>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Types of Installment Agreements</h2>
            <p className="mb-6">
              The IRS offers several types of payment plans:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-2">
              <li><strong>Short-term payment plan:</strong> Pay within 120 days (no setup fee)</li>
              <li><strong>Long-term payment plan:</strong> Monthly payments over more than 120 days</li>
              <li><strong>Direct debit installment agreement:</strong> Automatic bank withdrawals</li>
              <li><strong>Payroll deduction agreement:</strong> Payments through employer</li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              ...
              <li>You haven't had an installment agreement in the past 5 years</li>
              <li>You must stay current on all future tax obligations</li>
            </ul>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Fees and Costs</h2>
            <p className="mb-6">
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              ...
              <li>Interest and penalties continue to accrue during the payment period</li>
              <li>Direct debit agreements have lower setup fees</li>
            </ul>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Benefits of Installment Agreements</h2>
            <ul className="list-disc list-inside mb-6 space-y-2">
            ...
            <div className="bg-brand-teal/10 p-6 rounded-lg mt-12">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Need Help with Payment Plans?</h3>
